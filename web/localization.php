...
const TRANSLATIONS = [
    'nl' => [
        ...
        'ponos.settings.api_keys.hint' => 'Maak een vaste sleutel voor Sec-Bot of andere integraties. De volledige sleutel wordt één keer getoond; bewaar hem direct.',
        'ponos.settings.api_keys.label' => 'Naam',
        'ponos.settings.api_keys.label_placeholder' => 'bijv. Sec-Bot',
        ...
        'ponos.settings.api_keys.revoke_confirm' => 'Deze API-sleutel intrekken? Bestaande koppelingen (zoals Sec-Bot) werken daarna niet meer.',
    ...
    'en' => [
        ...
        'ponos.settings.api_keys.hint' => 'Create a durable key for Sec-Bot or other integrations. The full key is shown once; store it immediately.',
        'ponos.settings.api_keys.label' => 'Name',
        'ponos.settings.api_keys.label_placeholder' => 'e.g. Sec-Bot',
        ...
        'ponos.settings.api_keys.revoke_confirm' => 'Revoke this API key? Existing integrations (such as Sec-Bot) will stop working.',
    ...
    'de' => [
        ...
        'ponos.settings.api_keys.hint' => 'Erstellen Sie einen dauerhaften Schlüssel für Sec-Bot oder andere Integrationen. Der vollständige Schlüssel wird nur einmal angezeigt; speichern Sie ihn sofort.',
        'ponos.settings.api_keys.label' => 'Name',
        'ponos.settings.api_keys.label_placeholder' => 'z. B. Sec-Bot',
        ...
        'ponos.settings.api_keys.revoke_confirm' => 'Diesen API-Schlüssel widerrufen? Bestehende Kopplungen (z. B. Sec-Bot) funktionieren danach nicht mehr.',
    ...
    'fr' => [
        ...
        'ponos.settings.api_keys.hint' => 'Créez une clé durable pour Sec-Bot ou d\'autres intégrations. La clé complète n\'est affichée qu\'une seule fois ; enregistrez-la immédiatement.',
        'ponos.settings.api_keys.label' => 'Nom',
        'ponos.settings.api_keys.label_placeholder' => 'p. ex. Sec-Bot',
        ...
        'ponos.settings.api_keys.revoke_confirm' => 'Révoquer cette clé API ? Les intégrations existantes (comme Sec-Bot) cesseront de fonctionner.',
