...
const TRANSLATIONS = [
    'nl' => [
        ...
        'ponos.message.integration_of' => 'Integratie van %s',
        ...
        'ponos.preview.download' => 'Downloaden',
        'ponos.preview.loading' => 'Voorbeeld laden…',
        'ponos.preview.failed' => 'Voorbeeld kon niet worden geladen.',
        'ponos.preview.too_large' => 'Bestand is te groot voor een voorbeeld.',
        'ponos.preview.unsupported' => 'Geen voorbeeld beschikbaar voor dit bestand.',
        'ponos.preview.close' => 'Sluiten',
        'ponos.error.missing_param' => 'Ontbrekende parameter: %s',
        'ponos.error.unknown_action' => 'Onbekende actie.',
        'ponos.error.unauthorized' => 'Niet geautoriseerd.',
        'ponos.error.api_key_not_found' => 'API-key niet gevonden.',
        ...
        'ponos.stats.title' => 'Groepsstatistieken',
        'ponos.stats.btn' => 'Statistieken',
        'ponos.stats.user' => 'Gebruiker',
        'ponos.stats.created' => 'Aangemaakt',
        'ponos.stats.handled' => 'Afgerond',
        'ponos.stats.on_time_title' => 'Op tijd afgerond',
        'ponos.stats.on_time_hint' => 'Van afgeronde taken met deadline: percentage vóór of op de deadline klaar.',
        'ponos.stats.on_time_none' => 'Nog geen afgeronde taken met deadline.',
        'ponos.stats.categories_title' => 'Taken per categorie',
        'ponos.stats.empty' => 'Nog geen taken in deze groep.',
        'ponos.stats.tasks' => '%d taken',
        ...
        'ponos.error.group_task_access_denied' => 'Je hebt geen toegang om taken in deze groep te bewerken.',
        'ponos.group.read_only_hint' => 'Alleen bekijken. Voeg jezelf toe via Toegang om taken te bewerken.',
        ...
        'ponos.settings.title' => 'Instellingen',
        'ponos.settings.email_title' => 'E-mailvoorkeuren',
        ...
        'ponos.settings.api_keys.title' => 'API-sleutels',
        'ponos.settings.api_keys.hint' => 'Maak een vaste sleutel voor integraties. De volledige sleutel wordt één keer getoond; bewaar hem direct.',
        'ponos.settings.api_keys.label' => 'Naam',
        'ponos.settings.api_keys.label_placeholder' => 'bijv. eigen integratie',
        'ponos.settings.api_keys.actor_name' => 'Weergavenaam',
        'ponos.settings.api_keys.actor_name_placeholder' => 'optioneel, zichtbaar op berichten',
        'ponos.settings.api_keys.shows_as' => 'Zichtbaar als %s',
        'ponos.settings.api_keys.create' => 'Sleutel aanmaken',
        'ponos.settings.api_keys.empty' => 'Nog geen API-sleutels.',
        'ponos.settings.api_keys.id' => 'Id %s',
        'ponos.settings.api_keys.created' => 'Aangemaakt %s',
        'ponos.settings.api_keys.revoke' => 'Intrekken',
        'ponos.settings.api_keys.revoke_confirm' => 'Deze API-sleutel intrekken? Bestaande integraties werken daarna niet meer.',
        'ponos.settings.api_keys.reveal_title' => 'Bewaar deze sleutel nu',
        'ponos.settings.api_keys.reveal_hint' => 'Dit is de enige keer dat de volledige sleutel zichtbaar is. Kopieer hem naar je keystore.',
        'ponos.settings.api_keys.copy' => 'Kopiëren',
        'ponos.settings.api_keys.copied' => 'Gekopieerd',
        'ponos.settings.api_keys.dismiss' => 'Ik heb hem opgeslagen',
    ...
    'en' => [
        ...
        'ponos.message.integration_of' => 'Integration of %s',
        ...
        'ponos.preview.download' => 'Download',
        'ponos.preview.loading' => 'Loading preview…',
        'ponos.preview.failed' => 'Could not load preview.',
        'ponos.preview.too_large' => 'File is too large to preview.',
        'ponos.preview.unsupported' => 'No preview available for this file.',
        'ponos.preview.close' => 'Close',
        'ponos.error.missing_param' => 'Missing parameter: %s',
        'ponos.error.unknown_action' => 'Unknown action.',
        'ponos.error.unauthorized' => 'Unauthorized.',
        'ponos.error.api_key_not_found' => 'API key not found.',
        ...
        'ponos.stats.title' => 'Group statistics',
        'ponos.stats.btn' => 'Statistics',
        'ponos.stats.user' => 'User',
        'ponos.stats.created' => 'Created',
        'ponos.stats.handled' => 'Completed',
        'ponos.stats.on_time_title' => 'Completed on time',
        'ponos.stats.on_time_hint' => 'Of completed tasks with a due date: percentage finished on or before the deadline.',
        'ponos.stats.on_time_none' => 'No completed tasks with a due date yet.',
        'ponos.stats.categories_title' => 'Tasks by category',
        'ponos.stats.empty' => 'No tasks in this group yet.',
        'ponos.stats.tasks' => '%d tasks',
        ...
        'ponos.error.group_task_access_denied' => 'You do not have access to edit tasks in this group.',
        'ponos.group.read_only_hint' => 'View only. Add yourself via Access to edit tasks.',
        ...
        'ponos.settings.title' => 'Settings',
        'ponos.settings.email_title' => 'Email preferences',
        ...
        'ponos.settings.api_keys.title' => 'API keys',
        'ponos.settings.api_keys.hint' => 'Create a durable key for integrations. The full key is shown once; store it immediately.',
        'ponos.settings.api_keys.label' => 'Name',
        'ponos.settings.api_keys.label_placeholder' => 'e.g. my integration',
        'ponos.settings.api_keys.actor_name' => 'Display name',
        'ponos.settings.api_keys.actor_name_placeholder' => 'optional, shown on messages',
        'ponos.settings.api_keys.shows_as' => 'Shown as %s',
        'ponos.settings.api_keys.create' => 'Create key',
        'ponos.settings.api_keys.empty' => 'No API keys yet.',
        'ponos.settings.api_keys.id' => 'Id %s',
        'ponos.settings.api_keys.created' => 'Created %s',
        'ponos.settings.api_keys.revoke' => 'Revoke',
        'ponos.settings.api_keys.revoke_confirm' => 'Revoke this API key? Existing integrations will stop working.',
        'ponos.settings.api_keys.reveal_title' => 'Save this key now',
        'ponos.settings.api_keys.reveal_hint' => 'This is the only time the full key is shown. Copy it to your keystore.',
        'ponos.settings.api_keys.copy' => 'Copy',
        'ponos.settings.api_keys.copied' => 'Copied',
        'ponos.settings.api_keys.dismiss' => 'I have saved it',
    ...
    'de' => [
        ...
        'ponos.message.integration_of' => 'Integration von %s',
        ...
        'ponos.preview.download' => 'Herunterladen',
        'ponos.preview.loading' => 'Vorschau wird geladen…',
        'ponos.preview.failed' => 'Vorschau konnte nicht geladen werden.',
        'ponos.preview.too_large' => 'Datei ist zu groß für eine Vorschau.',
        'ponos.preview.unsupported' => 'Für diese Datei ist keine Vorschau verfügbar.',
        'ponos.preview.close' => 'Schließen',
        'ponos.error.missing_param' => 'Fehlender Parameter: %s',
        'ponos.error.unknown_action' => 'Unbekannte Aktion.',
        'ponos.error.unauthorized' => 'Nicht autorisiert.',
        'ponos.error.api_key_not_found' => 'API-Key nicht gefunden.',
        ...
        'ponos.stats.title' => 'Gruppenstatistik',
        'ponos.stats.btn' => 'Statistik',
        'ponos.stats.user' => 'Benutzer',
        'ponos.stats.created' => 'Erstellt',
        'ponos.stats.handled' => 'Abgeschlossen',
        'ponos.stats.on_time_title' => 'Pünktlich abgeschlossen',
        'ponos.stats.on_time_hint' => 'Von abgeschlossenen Aufgaben mit Fälligkeit: Anteil vor oder am Fälligkeitsdatum erledigt.',
        'ponos.stats.on_time_none' => 'Noch keine abgeschlossenen Aufgaben mit Fälligkeit.',
        'ponos.stats.categories_title' => 'Aufgaben pro Kategorie',
        'ponos.stats.empty' => 'Noch keine Aufgaben in dieser Gruppe.',
        'ponos.stats.tasks' => '%d Aufgaben',
        ...
        'ponos.error.group_task_access_denied' => 'Sie haben keinen Zugriff, um Aufgaben in dieser Gruppe zu bearbeiten.',
        'ponos.group.read_only_hint' => 'Nur ansehen. Fügen Sie sich unter Zugriff hinzu, um Aufgaben zu bearbeiten.',
        ...
        'ponos.settings.title' => 'Einstellungen',
        'ponos.settings.email_title' => 'E-Mail-Einstellungen',
        ...
        'ponos.settings.api_keys.title' => 'API-Schlüssel',
        'ponos.settings.api_keys.hint' => 'Erstellen Sie einen dauerhaften Schlüssel für Integrationen. Der vollständige Schlüssel wird nur einmal angezeigt; speichern Sie ihn sofort.',
        'ponos.settings.api_keys.label' => 'Name',
        'ponos.settings.api_keys.label_placeholder' => 'z. B. eigene Integration',
        'ponos.settings.api_keys.actor_name' => 'Anzeigename',
        'ponos.settings.api_keys.actor_name_placeholder' => 'optional, sichtbar auf Nachrichten',
        'ponos.settings.api_keys.shows_as' => 'Sichtbar als %s',
        'ponos.settings.api_keys.create' => 'Schlüssel erstellen',
        'ponos.settings.api_keys.empty' => 'Noch keine API-Schlüssel.',
        'ponos.settings.api_keys.id' => 'Id %s',
        'ponos.settings.api_keys.created' => 'Erstellt %s',
        'ponos.settings.api_keys.revoke' => 'Widerrufen',
        'ponos.settings.api_keys.revoke_confirm' => 'Diesen API-Schlüssel widerrufen? Bestehende Integrationen funktionieren danach nicht mehr.',
        'ponos.settings.api_keys.reveal_title' => 'Diesen Schlüssel jetzt speichern',
        'ponos.settings.api_keys.reveal_hint' => 'Dies ist das einzige Mal, dass der vollständige Schlüssel angezeigt wird. Kopieren Sie ihn in Ihren Keystore.',
        'ponos.settings.api_keys.copy' => 'Kopieren',
        'ponos.settings.api_keys.copied' => 'Kopiert',
        'ponos.settings.api_keys.dismiss' => 'Ich habe ihn gespeichert',
    ...
    'fr' => [
        ...
        'ponos.task.messages' => 'Messages',
        'ponos.message.integration_of' => 'Intégration de %s',
        ...
        'ponos.preview.download' => 'Télécharger',
        'ponos.preview.loading' => 'Chargement de l’aperçu…',
        'ponos.preview.failed' => 'Impossible de charger l’aperçu.',
        'ponos.preview.too_large' => 'Fichier trop volumineux pour un aperçu.',
        'ponos.preview.unsupported' => 'Aucun aperçu disponible pour ce fichier.',
        'ponos.preview.close' => 'Fermer',
        'ponos.error.missing_param' => 'Paramètre manquant : %s',
        'ponos.error.unknown_action' => 'Action inconnue.',
        'ponos.error.unauthorized' => 'Non autorisé.',
        'ponos.error.api_key_not_found' => 'Clé API introuvable.',
        ...
        'ponos.stats.title' => 'Statistiques du groupe',
        'ponos.stats.btn' => 'Statistiques',
        'ponos.stats.user' => 'Utilisateur',
        'ponos.stats.created' => 'Créées',
        'ponos.stats.handled' => 'Terminées',
        'ponos.stats.on_time_title' => 'Terminées à temps',
        'ponos.stats.on_time_hint' => 'Parmi les tâches terminées avec échéance : pourcentage terminé avant ou à la date limite.',
        'ponos.stats.on_time_none' => 'Aucune tâche terminée avec échéance pour l\'instant.',
        'ponos.stats.categories_title' => 'Tâches par catégorie',
        'ponos.stats.empty' => 'Aucune tâche dans ce groupe pour l\'instant.',
        'ponos.stats.tasks' => '%d tâches',
        ...
        'ponos.error.group_task_access_denied' => 'Vous n\'avez pas accès pour modifier les tâches de ce groupe.',
        'ponos.group.read_only_hint' => 'Consultation seule. Ajoutez-vous via Accès pour modifier les tâches.',
        ...
        'ponos.settings.title' => 'Paramètres',
        'ponos.settings.email_title' => 'Préférences e-mail',
        ...
        'ponos.settings.api_keys.title' => 'Clés API',
        'ponos.settings.api_keys.hint' => 'Créez une clé durable pour les intégrations. La clé complète n\'est affichée qu\'une seule fois ; enregistrez-la immédiatement.',
        'ponos.settings.api_keys.label' => 'Nom',
        'ponos.settings.api_keys.label_placeholder' => 'p. ex. mon intégration',
        'ponos.settings.api_keys.actor_name' => 'Nom affiché',
        'ponos.settings.api_keys.actor_name_placeholder' => 'facultatif, visible sur les messages',
        'ponos.settings.api_keys.shows_as' => 'Visible en tant que %s',
        'ponos.settings.api_keys.create' => 'Créer une clé',
        'ponos.settings.api_keys.empty' => 'Aucune clé API pour le moment.',
        'ponos.settings.api_keys.id' => 'Id %s',
        'ponos.settings.api_keys.created' => 'Créée le %s',
        'ponos.settings.api_keys.revoke' => 'Révoquer',
        'ponos.settings.api_keys.revoke_confirm' => 'Révoquer cette clé API ? Les intégrations existantes cesseront de fonctionner.',
        'ponos.settings.api_keys.reveal_title' => 'Enregistrez cette clé maintenant',
        'ponos.settings.api_keys.reveal_hint' => 'C\'est la seule fois que la clé complète est affichée. Copiez-la dans votre magasin de clés.',
        'ponos.settings.api_keys.copy' => 'Copier',
        'ponos.settings.api_keys.copied' => 'Copiée',
        'ponos.settings.api_keys.dismiss' => 'Je l\'ai enregistrée',
